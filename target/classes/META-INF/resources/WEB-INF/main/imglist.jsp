...
<body>
   ...
   <table class="imgtable">
    ...
    <c:forEach items="${pageInfo.dataList}" var="photo" >
      <tr>
	    <td class="image_container" ><a href="${photo.imgUrl}"><img src="${photo.imgUrl}" style="width:100px;height:100px; " /></a></td>
   ...
   <div class="message">共<i class="blue">${pageInfo.dataCount}</i>条记录，当前显示第&nbsp;<i class="blue">${pageInfo.currentlyPageNo}&nbsp;</i>页</div>
    ...
    <div id="box"> 
    		<video id="video" controls preload="auto" width="400px" height="300px"> 
    			<source src="http://bucket-zc.oss-cn-shanghai.aliyuncs.com/220c9.mp4?Expires=1872664338&OSSAccessKeyId=LTAIlViXWEGdEqN6&Signature=YtSe7DiXOTE7Z2T1owLUeEyl%2BC8%3D" type="video/mp4"> 
    		</video> 
    	</div>
...
<script type="text/javascript">
	layer.open({ type: 1, title: false, shadeClose: true, area: ['400px', '350px'], content: $('#box'), success: function(layero)
		{  setTimeout(function() { $(layero).removeClass('layer-anim'); }, 0); } });
