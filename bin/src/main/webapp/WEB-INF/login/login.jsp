...
<div class="logintop">    
    ...
    <ul>
	    <li><input name="account" id="account" type="text" class="loginuser" value="admin" onclick="this.value=''"/></li>
	    <li><input name="pwd" id="pwd" type="text" class="loginpwd" value="密码" onclick="this.value=''"/></li>
